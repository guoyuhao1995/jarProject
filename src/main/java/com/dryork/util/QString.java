...
public class QString {
	...
	@SuppressWarnings("unused")
	private static  byte[] decodeBASE64toByte(String s) {
		if (s == null)
			return null;
		BASE64Decoder decoder = new BASE64Decoder();
		try {
	...
	public static void main(String[] args) {
		...
		String tmp = QString.encodeBASE64("janson@FTM1lsRrRt+QHZquK6e/+A==");
		System.out.println(QString.get64MD5("Janson"));
		System.out.println(QString.get32MD5("asdagdsf34esdafasdv"));
		System.out.println(tmp+" ==> "+QString.decodeBASE64(tmp));
